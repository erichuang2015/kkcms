...
$zy='class="active"'?>
<title>追综艺-最新综艺-好看综艺-最新综艺排行-<?php echo $xtcms_seoname;?></title>
<meta name="keywords" content="追综艺,最新综艺,好看综艺,最新综艺排行,<?php echo $xtcms_keywords;?>">
...
echo "<li><a href='zongyi.php?m=/zongyi/list.php?cat=all&page=$previous_page'> << </a></li>";
for ($i=1; $i < $total_page; $i++) :
    if ($current_page == $i) {
        echo "<li><a href='zongyi.php?m=/zongyi/list.php?cat=all&page=$i'> $i   </a></li>";
    }else{
        echo "<li><a href='zongyi.php?m=/zongyi/list.php?cat=all&page=$i'> $i  </a></li>";
    }
endfor;
echo "<li><a href='zongyi.php?m=/zongyi/list.php?cat=all&pageno=$next_page'> >> </a></li>";
?></ul>
			</div>		</div>
	</div>
</div>
