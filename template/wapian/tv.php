...
echo "<li><a href='tv.php?m=/dianshi/list.php?cat=all&page=$previous_page'> << </a></li>";
for ($i=1; $i < $total_page; $i++) :
    if ($current_page == $i) {
        echo "<li><a href='tv.php?m=/dianshi/list.php?cat=all&page=$i'> $i   </a></li>";
    }else{
        echo "<li><a href='tv.php?m=/dianshi/list.php?cat=all&page=$i'> $i  </a></li>";
    }
endfor;
echo "<li><a href='tv.php?m=/dianshi/list.php?cat=all&page=$next_page'> >> </a></li>";
?></ul>
			</div>		</div>
	</div>
</div>
