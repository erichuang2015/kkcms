...
<div class="container">
<div class="row"  style="margin-top:0px"><?php echo get_ad(11)?></div></div>
...
?>
<li <?php if ($ye=="rankhot"){echo 'class="active"';}elseif($ye=="createtime"){}else{ echo 'class="active"';};?>><a href="?m=/dongman/list.php?rank=rankhot&page=1">最近热映</a></li>
					<li <?php if ($ye=="createtime"){echo 'class="active"';}else{};?>><a href="?m=/dongman/list.php?rank=createtime&page=1">最近上映</a></li>
				</ul>
			</div>
...
echo "<li><a href='dongman.php?m=/dongman/list.php?cat=all&page=$previous_page'> << </a></li>";
for ($i=1; $i < $total_page; $i++) :
    if ($current_page == $i) {
        echo "<li><a href='dongman.php?m=/dongman/list.php?cat=all&page=$i'> $i   </a></li>";
    }else{
        echo "<li><a href='dongman.php?m=/dongman/list.php?cat=all&page=$i'> $i  </a></li>";
    }
endfor;
echo "<li><a href='dongman.php?m=/dongman/list.php?cat=all&page=$next_page'> >> </a></li>";
?></ul>
			</div>		</div>
	</div>
</div>
