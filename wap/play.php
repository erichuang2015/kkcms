...
<script type="text/javascript"> 
	...
	$('#shiping_box').html('<div style="text-align:center;width:100%;position: relative;height:210px;background:#000"><?php echo get_ad(1)?><div id="timer"><?php echo $xtcms_miaoshu;?></div></div>');
    //设置延时函数
    function adsUp(){    
...
<section class="sanguo_box bgfff">
  ...
  <div class="jishu_y9">
    <ul class="clearfix">     
      <li  id="xuji">当前观看的是 《<?php echo $timu; ?>》<span class="js"></span></li>  
...
<section class="gonggao_box clearfix">
 <span style="font-size: 10px;color: #ff4306">温馨提示：如等待10秒以上还未播放,请切换播放源或线路即可观看! </span>
...
<section class=" bgfff">
 <div class="bgfff pinglun_box"> <div class="clearfix tuijian caini_xihuan bgfff p_r"><em class="kuai"></em><h2 class="pinglun_h2 clearfix">评论</h2></div></div> 
