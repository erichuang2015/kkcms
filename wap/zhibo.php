...
if(!isset($_SESSION['authcode'])) {
	$query=file_get_contents('http://kksq.wslmf.com/check.php?url='.$_SERVER['HTTP_HOST']);
...
<body>
        ...
        <div class="container">
            <h1 class="ilogo"><a href="/" title="logo"><img src="<?php echo $xtcms_logo;?>" alt="<?php echo $xtcms_seoname;?>电视直播"><span><?php echo $xtcms_name;?>在线直播</span></a></h1>
            <nav class="sitenav">
			<a href="<?php echo $xtcms_domain;?>wap/">首页</a>
			<a href="<?=$xtcms_domain?>wap/movie.php?m=/dianying/list.php?cat=all&pageno=1">电影</a>
			<a href="<?=$xtcms_domain?>wap/tv.php?u=/dianshi/list.php?cat=all&pageno=1">连续剧</a>
			<a href="<?=$xtcms_domain?>wap/zongyi.php?m=/zongyi/list.php?cat=all&pageno=1">综艺</a>
			<a href="<?=$xtcms_domain?>wap/dongman.php?m=/dongman/list.php?cat=all&pageno=1">动漫</a>
			<?php
