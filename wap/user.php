...
<!--页面style css-->
<link rel="stylesheet" href="<?php echo $xtcms_domain;?>wap/weui/weuix.min.css"/>
<link rel="stylesheet" type="text/css" href="<?php echo $xtcms_domain;?>wap/style/css/base.css">
<link rel="stylesheet" type="text/css" href="<?php echo $xtcms_domain;?>wap/style/css/li.css">
<script src="<?php echo $xtcms_domain;?>wap/weui/zepto.min.js"></script>
<script src="<?php echo $xtcms_domain;?>wap/style/js/li.js"></script>
...
<section class="touxiang_box">
  <div class="touxiang"> <img src="//q4.qlogo.cn/headimg_dl?dst_uin=<?php echo $_SESSION['user_name'];?>&spec=100"> </div>
    ...
    <li>
      ...
      <a href="user.php?op=yaoqing" onclick="$('.weui-share').show().addClass('fadeIn');">
        <div class="huiyuan tuijian_y8">
          <p class="clearfix">推广记录<span class="fr"><?php $sql1="SELECT COUNT(*) AS count FROM xtcms_user where u_qid=$u_id"; 
...
$count=$result1['count']; echo $count;?><em class="zhuandao2"></em></span></p>
    ...
    <li>
      <div class="huiyuan jifen" style="background: url(<?php echo $xtcms_domain;?>wap/style/images/shoucang.png) no-repeat 0.33rem center;background-size: 0.31rem 0.29rem">
        <a href="user.php?op=shoucang"><p class="clearfix">我的收藏：<span class="fr"><em class="zhuandao2"></em></span></p></a>
      </div>
    </li>
    <li>
      <div class="huiyuan jifen" style="background: url(<?php echo $xtcms_domain;?>wap/style/images/bangding.png) no-repeat 0.33rem center;background-size: 0.31rem 0.29rem">
    ...
    <div class="weui_panel_bd">
        <a href="javascript:void(0);" class="weui_media_box weui_media_appmsg">
            <div class="weui_media_hd">
                <img class="weui_media_appmsg_thumb circle" src="//q4.qlogo.cn/headimg_dl?dst_uin=<?php echo $_SESSION['user_name'];?>&spec=100" alt="">
            </div>
...
<input type="radio" id="profile_gender_0" name="pay" required="required" value="1" checked="">
								...
								<?php if($xtcms_zhifu=1){?><input type="radio" id="profile_gender_1" name="pay" required="required" value="alipay">
...
<div class="weui_panel">
<img src="<?php echo $xtcms_domain;?>wap/style/images/tequan.png" width="100%"> 
</div>
<style type="text/css">
...
<section class="wode_box bgfff">
我的推广链接：<?php echo $xtcms_domain;?>wap/login.php?op=create&tg=<?php echo $u_id ?>
</section>
...
<?php
  ...
  <?php } ?> 
  </ul>我不想邀请，直接购买充值卡充值：<a href="<?php echo $xtcms_qqun;?>" target="_blank">点此购买>>></a>
</section>
...
<div class="weui_panel weui_panel_access">           
    <div class="weui_panel_bd">
        <a href="javascript:void(0);" class="weui_media_box weui_media_appmsg">
            <div class="weui_media_hd">
                <img class="weui_media_appmsg_thumb circle" src="<?php echo $xtcms_domain;?>wap/style/images/icon_zjongxin_03.png" alt="">
            </div>
            <div class="weui_media_box  weui_media_text">
                <h4 class="weui_media_title"><?php echo $_SESSION['user_name']?><span class="icon icon-123" style="color: #9fc732"></span></h4>
                <p class="weui_media_desc">会员： <?php echo date('Y-m-d',$row['u_end'])?>到期 <br>积分：<?php echo $row['u_points'];?></p>
...
<input name="buycard" type="button" value="购买会员卡" onclick="window.open('<?php echo $xtcms_qqun;?>')" class="weui_btn weui_btn_primary" style="background-color: #9fc732;border-radius: 50px"/><a>
