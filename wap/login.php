    ...
    <form action="" method="post" class="form-horizontal form">
        <div class="login-user-name common-div">
            <span class="eamil-icon common-icon">
              <img src="<?php echo $xtcms_domain;?>wap/style/images/eamil.png" />
            </span>
            <input type="text" name="u_name" value="" placeholder="请输入您的账号（QQ号）" />        
          </div>
          <div class="login-user-pasw common-div">
            <span class="pasw-icon common-icon">
              <img src="<?php echo $xtcms_domain;?>wap/style/images/password.png" />
            </span>
                ...
                <div class="weui_cells weui_cells_form">
                    <div class="weui_cell">
                        ...
                        <div class="weui_cell_bd weui_cell_primary">
                            <input class="weui_input" name="name" id="tel" type="number" required pattern="[0-9]{11}" maxlength="11" placeholder="推荐填写QQ账号注册" emptyTips="推荐填写QQ账号注册" notMatchTips="推荐填写QQ账号注册">
                        </div>
                    ...
                    <?php if($xtcms_smsname!=""){?><div class="weui_cell weui_vcode">
                        <div class="weui_cell_hd">
